...
namespace ProStep.DataSourse.Migrations
{
    ...
    [Migration("20230523194400_initDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProStep.Model.Maps.Level", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProStep.Model.Maps.RoadMapLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("RoadMapLevel");
                });

            modelBuilder.Entity("ProStep.Model.Maps.Step", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProStep.Model.Maps.RoadMap", b =>
                {
                    b.HasOne("ProStep.Model.General.Category", "Category")
                        .WithOne("RoadMap")
                        .HasForeignKey("ProStep.Model.Maps.RoadMap", "CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProStep.Model.Maps.RoadMapLevel", b =>
                {
                    b.HasOne("ProStep.Model.Maps.Level", "Level")
            ...
            modelBuilder.Entity("ProStep.Model.Maps.Step", b =>
                {
                    b.HasOne("ProStep.Model.Maps.RoadMapLevel", "RoadMapLevel")
                        .WithMany("Steps")
